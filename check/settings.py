...
SECRET_KEY = os.getenv('SECRET_KEY', default='django-insecure-v$r%ssa2hafa-)&kkdf(pj)+z1i4lcsuvyt989z)z+=2luowr0')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('POSTGRES_DB', default='check_db'),
...
WKHTMLTOPDF_API_URL = os.getenv('WKHTMLTOPDF_API_URL', default='http://wkhtmltopdf:80')
